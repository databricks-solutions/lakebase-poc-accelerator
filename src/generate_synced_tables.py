...
Usage:
    # From base directory:
    python src/generate_synced_tables.py --config workload_config.yml --output resources/synced_delta_tables.yml
    python src/generate_synced_tables.py --config quickstarts/quickstarts_workload_config.yml --output quickstarts/resources/synced_delta_tables.yml
