...
# NOTE: LakebaseDependency (provisioned, startup-bound) is intentionally not imported.
# This app is autoscaling-only and connects on-demand; see core/__init__.py for rationale.
